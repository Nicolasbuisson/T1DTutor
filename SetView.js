...
export default function SetView(props) {
    ...
    return (
        ...
        {view==="PasswordResetScreen" && <PasswordResetScreen></PasswordResetScreen>}
        {view==="Question1screen" && <Question1screen></Question1screen>}
        {view==="Question2screen" && <Question2screen></Question2screen>}
        {view==="Question2bisscreen" && <Question2bisscreen></Question2bisscreen>}
        {view==="InjectionOrPumpScreen" && <InjectionOrPumpScreen></InjectionOrPumpScreen>}
        ...
        {view==="LearningModulesScreen" && <LearningModulesScreen></LearningModulesScreen>}
        {view==="MythBusters" && <MythBusters></MythBusters>}
        {view==="KeepingYourSugarsAtTarget" && <KeepingYourSugarsAtTarget></KeepingYourSugarsAtTarget>}
        {view==="LowBloodSugar" && <LowBloodSugar></LowBloodSugar>}
        {view==="HighBloodSugar" && <HighBloodSugar></HighBloodSugar>}
        {view==="PreventingComplications" && <PreventingComplications></PreventingComplications>}
        {view==="AlcoholAndOtherSubstances" && <AlcoholAndOtherSubstances></AlcoholAndOtherSubstances>}
        {view==="DrivingWithDiabetes" && <DrivingWithDiabetes></DrivingWithDiabetes>}
        {view==="DiabetesAndPregnancy" && <DiabetesAndPregnancy></DiabetesAndPregnancy>}
        {view==="PeerSupportAndMentalHealth" && <PeerSupportAndMentalHealth></PeerSupportAndMentalHealth>}
        {view==="InnovativeDiabetesTech" && <InnovativeDiabetesTech></InnovativeDiabetesTech>}
