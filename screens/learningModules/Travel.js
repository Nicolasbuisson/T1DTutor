      ...
      return (
        <View style={styles.container}>
          ...
          >
            <View style={styles.listItem}>
              <Text style={styles.italicized}>
              Adapté par Diabète Canada
              </Text>
              <Text style={styles.text}>
              Vous partez en voyage. Que devez-vous apporter? Comment pouvez-vous vous préparer? 
              Voici une liste de certaines choses que vous devez garder à l'esprit lorsque vous voyagez avec le diabète.
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>Conseils de voyage généraux</Text>
              <Text style={styles.text}>
                {"\n"} - Assurez-vous que vos vaccins sont à jour pour votre destination de voyage.
                {"\n"} - Ayez une lettre de votre médecin indiquant que vous devez transporter des médicaments ou des fournitures parce que certaines compagnies aériennes et certains pays l'exigent.
                {"\n"} - Ayez sur vous une liste de vos médicaments - vous pouvez l'obtenir auprès de votre pharmacien.
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>
              ...
              <Text style={styles.text}>
                {"\n"} - Ayez toujours votre insuline et vos fournitures avec vous dans votre bagage à main. Ne placez pas d'insuline dans vos bagages enregistrés car les fluctuations de température peuvent l'endommager.
                {"\n"} - Lorsque vous voyagez en avion, vous pouvez transporter des liquides tels que de l'insuline, du jus ou des gels pour traiter l'hypoglycémie, etc., même en quantités supérieures à 100 ml. Assurez-vous simplement qu'ils sont accessibles et déclarez-les à la sécurité lors du dépistage.
                {"\n"} - Les seringues et aiguilles sont également autorisées dans votre bagage à main, à condition que vous ayez également avec vous le médicament injectable (par exemple, l'insuline).
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>Stockage de l'insuline en voyage</Text>
              <Text style={styles.text}>
                {"\n"} - L'insuline doit être conservée correctement, car elle se gâtera si elle est laissée à des températures trop chaudes ou trop froides.
                {"\n"} - L'insuline conserve sa concentration à température ambiante pendant 30 jours. Si vous voyagez par temps chaud, stockez votre insuline dans un sac isotherme. Si vous voyagez par temps froid, gardez votre insuline près de votre corps pour l'empêcher de geler.
                {"\n"} - Vous pouvez transporter un petit contenant pour objets tranchants pour ranger les aiguilles et les seringues usagées lorsque vous voyagez.
                {"\n"} - Emportez des seringues et de l'insuline de rechange et des réserves de tout autre médicament ou matériel médical.
                {"\n"} - Si des installations de lavage des mains ne sont pas disponibles, emportez des tampons imbibés d'alcool, des lingettes humides ou un désinfectant pour les mains pour nettoyer vos doigts avant le test.
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>
              ...
              <Text style={styles.text}>
                {"\n"} - C'est une bonne idée de parler à votre médecin ou à votre éducateur en diabète avant de modifier votre horaire ou votre posologie.
                {this.state.showInjections && (
                  <Text>
                    {"\n"} - Lorsque vous voyagez vers l'est, votre journée de voyage sera plus courte. Si vous perdez plus de deux heures, vous devrez peut-être prendre moins d'unités d'insuline à action intermédiaire ou prolongée.
                  </Text>
                )}
                {"\n"} - Lorsque vous voyagez vers l'ouest, votre journée de voyage sera plus longue. Si vous gagnez plus de deux heures, vous devrez peut-être prendre des unités supplémentaires d'insuline à action brève et plus de nourriture.
                {"\n"} - Si vous traversez des fuseaux horaires, vous devriez discuter de votre horaire de repas et d'insuline avec votre médecin ou votre éducateur en diabète.
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>Contrôle d'aéroport</Text>
              <Text style={styles.text}>
                {"\n"} - Vous n'êtes pas obligé de divulguer votre diabète au personnel de dépistage.
                {this.state.showPump && (
                  <Text>
                    {"\n"} - Vous n'êtes pas obligé de retirer votre pompe à insuline pour le dépistage. Informez simplement l'agent de contrôle que vous en portez un.
                  </Text>
                )}
                {this.state.showCGM ||
                  (this.state.showPump && (
                    <Text>
                      {"\n"} - Ne portez pas de pompe à insuline ou de CGM à travers le scanner corporel et ne placez pas votre pompe à insuline dans l'appareil à rayons X car ils peuvent affecter le fonctionnement des dispositifs. Au lieu de cela, vous pouvez demander à l'agent de contrôle d'effectuer une fouille physique à la place (dans un endroit privé, si vous le souhaitez).
                      {"\n"} - Les détecteurs de métaux portables n'affectent pas le fonctionnement des pompes à insuline ou des CGM.
                    </Text>
                  ))}
              </Text>
            </View>
            <View style={styles.listItem}>
              ...
              Avant de partir, n'oubliez pas de vous procurer:
                ...
                {this.state.showInjections && (
                  <Text>
                    {"\n    "} - Vous devez transporter des seringues ou des aiguilles pour crayons à insuline et lancettes dans le cadre de votre traitement par insuline. Cela vous sera utile si vos bagages sont examinés aux points de contrôle de sécurité de l'aéroport.
                    {"\n    "} - Les fournitures dont vous avez besoin pour vos soins du diabète. Assurez-vous de conserver vos seringues, aiguilles, crayons et lancettes dans les mêmes boîtes dans lesquelles ils ont été livrés avec l'étiquette de prescription d'origine.
                  </Text>
                )}
                {this.state.showPump && (
                  <Text>
                    {"\n    "} - Vous devez transporter des fournitures de pompe, des fournitures de mesure du glucose, de l'insuline et des seringues supplémentaires faisant partie de votre traitement. Cela vous sera utile si vos bagages sont examinés aux points de contrôle de sécurité de l'aéroport.
                    {"\n    "} - Une liste des fournitures dont vous avez besoin pour vos soins du diabète (y compris le traitement de l'hypoglycémie). S'ils sont prescrits, conservez-les dans les mêmes boîtes dans lesquelles ils sont venus avec l'étiquette de prescription originale.
                  </Text>
                )}
                {"\n"} - Demandez à votre médecin, à votre éducateur en diabète ou à votre équipe de soins de santé:
                {"\n    "} - Gestion des maladies
                {"\n    "} - Gestion de l'hypoglycémie
                {"\n    "} - Ajustements pour les repas, l'insuline et les médicaments dans différents fuseaux horaires
                {"\n    "} - Éviter les maladies causées par des aliments et de l'eau contaminés
                {"\n    "} - Conseils pour ajuster votre médication si nécessaire
              </Text>
            </View>
            <View style={styles.listItem}>
              <Text style={styles.title}>Liste de colisage</Text>
              <Text style={styles.text}>
                {"\n"} - Les numéros de téléphone de votre médecin et de votre éducateur en diabète
                ...
                {"\n"} - Des collations pour couvrir les repas retardés, comme des craquelins et des fruits
                {"\n"} - Fourniture supplémentaire de seringues, d'aiguilles et d'un stylo à insuline supplémentaire si utilisé
                {"\n"} - Bandelettes de test de cétone 
                {"\n"} - Glucagon
                {this.state.showCGM && <Text>{"\n"} - Fournitures pour les capteurs de glucose</Text>}
                {"\n"} - Les batteries ou chargeurs pour aucun machine médical qui en a besoin
                {this.state.showPump && (
                  <Text>
                    {"\n"} - Fournitures pour la pompe 
                    {"\n"} - Pompe à insuline supplémentaire si disponible ou insuline de secours à action prolongée en cas de dysfonctionnement de la pompe
                  </Text>
                )}
              </Text>
            </View>
