    ...
    dbh
      ...
      .then((doc) => {
        if (doc.exists) {
          ...
          if (doc.data().questions.checkBloodSugar === "Finger-prick testing") {
          ...
          {!this.state.showPump && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                symptoms do not improve in 24 hours, if you develop a fever, or
                if the red area gets larger.
                {"\n"}
          ...
          {this.state.showPump && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                group increases insulin absorption and your chances of a low
                blood sugar. Example, an infusion site in your leg if you are a
                runner
                ...
                skin with an antibacterial soap (eg. Dial®, Betadine®,
                ...
                clear dressing for your cannula, and place another dressing over
                top of the infusion set tape.
                ...
                removal product like Remove® or Unisolve® to gently unstick the
                tape.
                {"\n"} - Try a barrier wipe such as Cavillon®, or placing
                another dressing on your skin (such as Tegaderm®, Biocclusive®,
                IV 300®), being sure to cut a small hole for your cannula.
                ...
                cannula. Use Flovent® and other steroid creams sparingly, and
                with caution, as they cause thinning of your skin.
              </Text>
            </View>
          )}
          ...
          {this.state.showCGM && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                {"\n"} - Try the “sandwich technique.” Cut a small hole in a
                clear dressing for your sensor, and place another dressing over
                top of the sensor tape.
                ...
                {"\n"} - Try a barrier wipe such as Cavillon®, or placing
                another dressing on your skin (such as Tegaderm®, Biocclusive®,
                IV 300®), being sure to cut a small hole for your sensor.
                {"\n"} - Discuss using Flovent® on your skin with your physician
                (avoiding the actual insertion site) before you change your
                sensor. Use Flovent® and other steroid creams sparingly, and
                with caution, as they cause thinning of your skin.
                ...
                {"\n\n"}WHEN IN DOUBT…TAKE IT OUT!!!!
                {"\n\n"}Try warm compresses, and seek medical help if the
                symptoms do not improve in 24 hours, or if you develop a fever,
