...
class FindingPatterns extends Component {
  ...
  componentDidMount() {
    ...
    dbh
      ...
      .then((doc) => {
        if (doc.exists) {
          // if (doc.data().questions.pump === "670") {
          ...
          {!this.state.showPump && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                reduced. This should be corrected as soon as possible - having
                low sugar when you are not awake can be very dangerous.
                ...
                untreated low blood sugar at night can cause your sugar to go
                high after. If not, increase your long-acting insulin.
                ...
                snacking without giving insulin, snacking is the cause. If you
                do not have an insulin dose for snacking, talk to your
                healthcare team about this. Otherwise, try to avoid snacking on
                foods with starch or sugar when you are hungry.
          ...
          {this.state.showPump && !this.state.Pump670 && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                how many units to give per grams of carbohydrates. For example,
                a ratio of 1:10 means you give 1 unit for 10 grams. If you need
                to give more insulin, the ratio needs to go down because you are
                ...
                is also a ratio. A factor of 1:4, or 4, means that for 1 unit of
                insulin, your blood sugar drops by 4 mmol/L. If you need to give
                more insulin, the number needs to go down because you are
                dividing by a smaller number (and vice versa).
                {"\n\n"}
                Here are some rules of thumb for low blood sugars:
                ...
                decreased. Decrease your basal rates by at least 0.05
                units/hour. For example, if you have different basal rates at
                midnight and 3 am, and you have a low blood sugar at 2 am, your
                midnight basal rate needs to be reduced.
                ...
                cause a stress response that makes your sugar high. If this is
                not the case, increase your basal rates before.
                {"\n"} - If your blood sugar is high after a low blood sugar,
          ...
          {this.state.showPump && this.state.Pump670 && (
            <View style={styles.listItem}>
              ...
              <Text style={styles.text}>
                ...
                This is also a ratio. For example, a factor of 1:4, or 4, means
                that for 1 unit of insulin, your blood sugar drops by 4 mmol/L.
                If you need to give more insulin, the number needs to go down
                ...
                changed, while your basal rates, ISF, and targets are set by the
                pump.
                {"\n\n"}
                Here are some rules of thumb for low blood sugars:
                {"\n"} - If you have low blood sugar right after a meal, the ICR
                used before the episode must be changed to prevent low blood
                sugar. For example, if you have low blood sugar after lunch,
                your lunchtime ICR needs to be increased by 0.5 to 1. If your
                ICR at lunchtime is 1:10, increase to 1: 10.5 or 1:11 (the
                option of 0.5 depends on the pump type).
                {"\n"} - If your blood sugar is below target a long time after a
                meal or overnight, your active insulin time should be increased
                by 15 - 30 minutes.
                {"\n\n"}
                Here are some rules of thumb for high blood sugars:
                {"\n"} - If your blood sugar rises by at least 3 mmol/L right
                ...
                basal rates may need to be adjusted. If you are using Manual
                Mode, here are other rules to consider:
                {"\n"} - If you have low blood sugar a long time after a meal or
                overnight, your basal rates right before the episode should be
                decreased. Decrease your basal rates by at least 0.05
                units/hour. For example, if you have different basal rates at
