...
class Question2screen extends Component {
  ...
  goToNextScreen(value) {
    this.context.setUser({
      ...this.context.user,
      questions: { ...this.context.user?.questions, typeOfRealTime: value },
    });
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.fieldsContainer}>
          <Greenbutton
            title="Dexcom"
            onPress={() => this.goToNextScreen("Dexcom")}
          ></Greenbutton>
          <Greenbutton
            title="Medtronic Guardian Con."
            onPress={() => this.goToNextScreen("Medtronic Guardian Con.")}
          ></Greenbutton>
          <Greenbutton
            title="Medtronic Guardian/Enlite"
            onPress={() => this.goToNextScreen("Medtronic Guardian/Enlite")}
          ></Greenbutton>
        </View>
